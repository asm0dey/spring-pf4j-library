...
import generated.jooq.keys.AUTHOR_FULL_NAME_KEY
import generated.jooq.keys.AUTHOR_PKEY
import generated.jooq.keys.BOOK_AUTHOR__BOOK_AUTHOR_AUTHOR_ID_FKEY
...
open class Author(
     ...
     */
    val ID: TableField<AuthorRecord, Long?> = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "")
     ...
     */
    val ADDED: TableField<AuthorRecord, OffsetDateTime?> = createField(DSL.name("added"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    /**
     * The column <code>public.author.full_name</code>.
     */
    val FULL_NAME: TableField<AuthorRecord, String?> = createField(DSL.name("full_name"), SQLDataType.CLOB.nullable(false), this, "")
    ...
    override fun getUniqueKeys(): List<UniqueKey<AuthorRecord>> = listOf(AUTHOR_FULL_NAME_KEY)
